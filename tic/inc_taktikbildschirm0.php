...
// ------------------
		$dsp .= "			<td bgcolor=".$farb_zusatz2." style='text-align: center'>" . getKampfSimuLinksForTarget($koord_g, $koord_p, "<img src=\"./bilder/default/swords.gif\" width=\"20\" height=\"20\" border=\"0\" alt=\"Simulation\" title=\"Simulation\"></a>")  ."</td>\n";
