...
if(isset($importlog) && is_array($importlog)) {
	$rows = (count($importlog) > 10) ? 10 : count($importlog);
	echo '<tr class="datatablehead"><td><b>Importlog</b></td></tr><tr><td><textarea style="width: 98%;" rows="'.$rows.'">';
	if(count($importlog) > 0) {
		foreach($importlog as $v) {
			echo $v . "\n";
		}
	} else {
		echo 'Kein Objekt erkannt.';
	}
	echo '</textarea></td></tr>';
}
?>
		...
		<tr>
            ...
            <td width="67%" valign="top">
              <table width="100%" cellspacing="2">
                ...
                <tr>
                  <td style="background-color: rgb(200, 200, 0)"><b>Importparser wurde redesigned, bitte Fehler melden.</b><br/>Taktik-Import ist mit Chrome inh&auml;rent nicht m&ouml;glich.</td>
                </tr>
                <tr>
